...
export type CommentLikeWhereInput = {
  ...
  createdAt?: Prisma.DateTimeNullableFilter<"CommentLike"> | Date | string | null
...
export type CommentLikeScalarWhereWithAggregatesInput = {
  ...
  createdAt?: Prisma.DateTimeNullableWithAggregatesFilter<"CommentLike"> | Date | string | null
}

export type CommentLikeCreateInput = {
  createdAt?: Date | string | null
  comment: Prisma.CommentCreateNestedOneWithoutLikesRelInput
...
export type CommentLikeUpdateInput = {
  ...
  comment?: Prisma.CommentUpdateOneRequiredWithoutLikesRelNestedInput
...
export type CommentLikeOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"commentId" | "userId" | "createdAt", ExtArgs["result"]["commentLike"]>
...
export interface CommentLikeDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * })
   * 
   * // Update zero or more CommentLikes and only return the `commentId`
   * const commentLikeWithCommentIdOnly = await prisma.commentLike.updateManyAndReturn({
   *   select: { commentId: true },
   *   where: {
   *     // ... provide filter here
   *   },
